      ...
      <div className="w-[min(1200px,92vw)] mx-auto px-6">
        ...
        >
          ...
          {STEPS.map(({ n, title, text, image, Icon }, i) => (
            ...
            >
              {/* Image en haut (taille fixe, ratio propre) */}
              ...
              {/* Icône ronde sous l’image (64–80px, jamais pleine largeur) */}
              ...
              {/* Connecteur fléché entre cartes (desktop) */}
              {i < STEPS.length - 1 && (
                <svg
                ...
                >
                  <line x1="0" y1="3" x2="92" y2="3" stroke="currentColor" strokeWidth="3" className="text-[var(--accent)]/70" strokeDasharray="6 6" />
                  <polygon points="92,0 100,3 92,6" className="fill-[var(--accent)]/80" />
                </svg>
              )}
            </motion.div>
          ))}
